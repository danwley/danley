...
---
Current position: AI researcher at [Guide Labs](https://www.guidelabs.ai/) redesigning LLMs to learn to output which training data they are using every time they make a prediction ([blog](https://www.guidelabs.ai/post/prism/)).

I'm a PhD student at Harvard, supervised by [Hima Lakkaraju](https://himalakkaraju.github.io/), researching trustworthy ML. We recently worked on [efficient data attribution techniques](https://arxiv.org/abs/2410.09940) and [faithful reasoning in LLMs](https://arxiv.org/abs/2406.10625).
